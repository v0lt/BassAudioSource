...
HSTREAM BASSALACDEF(BASS_ALAC_StreamCreateFile)(DWORD filetype, const void *file, QWORD offset, QWORD length, DWORD flags);
...
static inline HSTREAM BASS_ALAC_StreamCreateFile(DWORD filetype, const WCHAR *file, QWORD offset, QWORD length, DWORD flags)
{
	return BASS_ALAC_StreamCreateFile(filetype, (const void*)file, offset, length, flags | BASS_UNICODE);
}
